            ...
            while (matcher.find()) {
                ...
                while (group <= matcher.groupCount()) {
                    if (matcher.group(group) != null) {
                        ...
                        final Integer endIndex = getSmallestInt(Arrays.asList(Integer.valueOf(endIndex1), Integer.valueOf(endIndex2),
                            Integer.valueOf(endIndex3), Integer.valueOf(endIndex4)));
